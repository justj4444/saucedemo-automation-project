...
def test_checkout_total_matches_cart(logged_in_user: Page, add_products_to_cart: Page) -> None:
    ...
    print(f"Total price in cart before checkout: {cart_page_products}")      #get total price of products in cart before checkout
    ...
    print(f"Total price in checkout overview page: {checkout_overview_page_products}")      #get total price of products in checkout overview page
